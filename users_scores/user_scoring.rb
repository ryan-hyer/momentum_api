...
def send_voted_message(current_voter_points, max_points_possible, user_badge_level, users_username, voting_user, poll_url)
...
def send_not_voted_message(users_username, voting_user, poll_url)
