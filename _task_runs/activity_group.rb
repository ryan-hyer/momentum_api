...
discourse_options = {
    ...
    # target_username:        'Steve_Scott',     # David_Kirk Steve_Scott John_Butler Kim_Miller Jerry_Strebig Lee_Wheeler
    target_groups:          %w(GreatX),       # Mods GreatX BraveHearts trust_level_1
    instance:               'live',
