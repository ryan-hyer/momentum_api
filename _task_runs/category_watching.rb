...
discourse_options = {
    ...
    # target_username:        'William_Burton',       # Vern_Mcgeorge David_Kirk Mitch_Slomiak Kim_Miller Andrew_Webster
    target_groups:          %w(z_Legacy30),  # Mods GreatX BraveHearts trust_level_0 trust_level_1 z_Legacy30
